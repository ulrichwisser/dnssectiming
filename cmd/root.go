...
var rootCmd = &cobra.Command{
	Use:   "dnssectiming",
	Short: "Collect and analyze data to find a domains dnssec timing configuration",
	Long: `
	`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".dnssectiming" (without extension).
		viper.SetConfigType("yaml")
		viper.AddConfigPath(".")
		viper.AddConfigPath(home)
		viper.SetConfigName(".dnssectiming")

	}
	viper.SetEnvPrefix("DSECT")
